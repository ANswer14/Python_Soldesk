...
beverage, num = input('좋아하는 음료 : '), int(input('하루에 마시는 횟수 : '))
print("저는 %s를 좋아하고, 하루 %d잔을 마십니다." % (beverage, num) )
print("--------------")

# Python 3.6.X부터 f-string이라고 부르는 포맷팅을 좀 더 쉽게 할 수있는 방법이 추가됨

# f-string의 형태는 f와 {}만 아시면 됩니다 ~
# f"문자열 {변수명} 문자열..." 의 형태
print(f"저는 {beverage}를 좋아하고, 하루 {num}잔을 마십니다.")
print("--------------")
...
# 5가 기준이 될 때 
# 0, 1, 2만 반올림 처리가 안됨...(왜지? => 공식문서!! 이진 부동소수점의 한계) 
print('----------')
