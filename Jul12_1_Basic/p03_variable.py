...
a = 1231242
print(id(a))
a = 12376128736189273619283761298736
print(id(a))
a = 20
a = 12376128736189273619283761298736
print(id(a))
a = 12.182931692874698172361982746
print(id(a))
a = 20
a = 12.182931692874698172361982746
print(id(a))
print("이상한 숫자1")
a = 19823746198237461923874612938746129384761230948710192834710293847
print(id(a))
print("20")
a = 20
print(id(a))
...
p_tuple = 5, 7, 6 # tuple(튜플) 소괄호 생략 가능
